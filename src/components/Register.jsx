        ...
        <>
            {success ? (
                ...
                <section>
                    ...
                    <h1>Register for BilboMD Account</h1>
                    <form onSubmit={handleSubmit}>
                        ...
                        <label htmlFor="confirm_pwd">
                            ...
                            <FontAwesomeIcon
                                icon={faCheck}
                                className={
                                    validPwdMatch && matchPwd ? "valid" : "hide"
                                }
                            />
                            <FontAwesomeIcon
                                icon={faTimes}
                                className={
                                    validPwdMatch || !matchPwd
                                        ? "hide"
                                        : "invalid"
                                }
                            />
                        ...
                        <button
                            disabled={
                                !validName || !validPwd || !validPwdMatch
                                    ? true
                                    : false
                            }
                        >

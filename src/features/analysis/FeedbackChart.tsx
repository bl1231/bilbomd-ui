...
// Define the prop types for the data passed into the component
      ...
      <CardContent>
        ...
        >
          ...
          <ReferenceArea
            ...
            yAxisId='left'
          >
            <Label value='LOW-Q' offset={5} position='top' />
          </ReferenceArea>
          ...
          <ReferenceArea
            ...
            yAxisId='left'
          >
            <Label value='MID-Q' offset={5} position='top' />
          </ReferenceArea>
          ...
          <ReferenceArea
            ...
            yAxisId='left'
          >
            <Label value='HIGH-Q' offset={5} position='top' />
          </ReferenceArea>

          {/* Vertical reference lines for the region boundaries */}
          <ReferenceLine x={0.1} stroke='red' label='0.1' yAxisId='left' />
          <ReferenceLine x={0.2} stroke='red' label='0.2' yAxisId='left' />

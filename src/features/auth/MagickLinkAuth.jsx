...
const MagickLinkAuth = () => {
  ...
  const content = isLoading ? (
    ...
    <Alert severity="success">
      <AlertTitle>Woot!</AlertTitle>Your OTP has been successfully validated. Come on in.
    </Alert>
  ) : (
    <Alert severity="warning">
      <AlertTitle>Warning!</AlertTitle>Hmmmmm. Maybe your MagickLink&#8482; has expired? Please try{' '}
      <a href="http://localhost:3001/magicklink">generating another</a>. If that doesn't work please
      contact us.
      <p>{error}</p>
    </Alert>
  );
